...
go test -count=1 ./test/integration -run '^(TestFlowTreeReadUsesExactSourceLookupBeforeDetails|TestFlowTreeSnapshotUsesSourceSpecificEntryNodes|TestSubmittedFinishedInstanceIsNotConfigurable|TestSubmittedAwaitSentInstanceRemainsConfigurable|TestFlowTreeReadSessionExpiryReplaysWholeChainOnce)'
