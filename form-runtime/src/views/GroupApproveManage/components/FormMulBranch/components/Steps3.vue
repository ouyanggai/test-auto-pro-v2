  ...
  <div class="flow-main">
    ...
    <div class="fd-nav-content">
      <section class="dingflow-design">
        ...
        <div
          id="box-scale"
          class="box-scale"> <!-- :style="'transform: scale(' + nowVal / 100 + '); transform-origin: 50% 0px 0px;'" -->
          <NodeWrap
...
export default {
    ...
    flowNodes: { // 深度监听，可监听到对象、数组的变化
      handler(val) {
        ...
        if (this.editType != 1 || this.isInputFlow) {
          this.nodeConfig = val;
          console.log('this.nodeConfig-加签',this.nodeConfig)
        }
      }
      // deep: true
    }
  ...
  created() {
    // console.log('step3-加签',this.flowNodes)
    // console.log('this.editType-加签', this.editType)
    this.nodeConfig = this.flowNodes;
    console.log('this.nodeConfig-616',this.nodeConfig)
    console.log('this.templateData-616',this.templateData)
    console.log('this.fields-616',this.fields)
    console.log('this.flowNodes-616',this.flowNodes)
    console.log('this.editType-616',this.editType)
    console.log('this.flowNodeProxyId-616',this.flowNodeProxyId)
