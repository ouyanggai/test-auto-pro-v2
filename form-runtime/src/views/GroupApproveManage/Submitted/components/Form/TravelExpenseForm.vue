...
<template>
  <div class="list-container">
    ...
    <div class="form-container travel">
      <h3>出差人员</h3>
      <eltables :eltableConfig="travelPersonTableConfig" :showAddBt="true"></eltables>
    </div>
    ...
    <div class="form-container">
      <h3>费用预算类型</h3>
      <eltables :eltableConfig="costTypeTableConfig" :showAddBt="true"></eltables>
    </div>
    <div class="form-container">
      <h3>发票信息</h3>
      <billTable></billTable>
...
export default {
  ...
  methods: {
    getAllUsersOfGroup() {
      ...
      this.$axios.post(Api.user.findByCompanyIdUserList, { data, pagination: true, size: 5000 }, res => {
        if (res.isSuccess) {
          const data = res.data;
          var allPerson = data.dataList || [];
          ...
          this.travelPersonTableConfig[2].slot.source = deepClone(allPerson);
        }
      });
    },
    cancel() {
