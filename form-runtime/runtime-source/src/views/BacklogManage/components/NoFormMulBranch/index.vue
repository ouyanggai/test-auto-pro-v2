...
<template>
  <div class="flow-container">
    ...
    <div class="flow-content">
      ...
      /> -->
      <!-- v-show="stepsActive == (isNoFormFlow ? 2 : 1)" -->
      <!-- :isInputFlow="isInputFlow" -->
      <!-- :flow-nodes="formDetailData.flowNodes" -->
      <!-- :flow-nodes="originalNodeConfig" -->
      <Steps3
        ref="steps3"
...
export default {
  ...
  created() {
    console.log('originalNodeConfig3',this.originalNodeConfig)
  ...
  methods: {
    ...
    //   console.log('saveCustomFlowTemplate')
    //   this.verifyFlag = [];
    //   this.verifyFlag.length = 0;
    ...
    //     // {
    //     //   otherBiz: 'sid',
    //     //   otherBizId: localstorageGet('token')
    //     // }
    //   ];
    //   // if (this.$route.query?.relative) {
